...
return {
  ...
  opts = {
    options = {
      ...
      indicator = {
        icon = "",
        style = "none", -- Clean look without indicators
      },
      buffer_close_icon = "",
      modified_icon = "●",
      close_icon = "",
      ...
      show_tab_indicators = false, -- Remove tab indicators for cleaner UI
      show_duplicate_prefix = false,
      persist_buffer_sort = true,
      separator_style = "thin", -- Minimal separators for clean look
      enforce_regular_tabs = false, -- More natural sizing
      ...
      offsets = {
        {
          ...
          text = "  Explorer",
          text_align = "left",
          separator = false, -- No separator for cleaner look
        },
      },
